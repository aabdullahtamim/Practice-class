...
function LeftSidebar() {
    return (
        <div className="p-2.5 border-r border-gray-300 w-[180px] h-full absolute left-0 top-0 ">
            <div className="flex items-center border-[1.5px] border-theme px-4 py-2 rounded-md relative">
                <FiSearch className="text-[18px] absolute top-1/2 left-[15px] -translate-1/2" />
                <input className="dark:text-white text-[15px] pl-5 focus:outline-0" type="search" placeholder="Search Book....." />
            </div>
            <div className="mt-3">
                <ul>
                    ...
                    <ListItems title="Favorites" icon={<IoMdStarOutline />} />
                </ul>
            </div>
        </div >
    );
