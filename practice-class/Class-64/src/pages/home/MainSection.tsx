...
const MainSection = () => {
  return (
    <div className="container mx-auto py-10 lg:py-16 px-6 xl:px-6 flex flex-col lg:flex-row items-start gap-8">
      <div>
      ...
      <aside className="sticky top-8 shrink-0 lg:max-w-[300px] w-full">
