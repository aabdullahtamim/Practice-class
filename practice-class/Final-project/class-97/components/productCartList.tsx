...
function ProductCartList() {
    return (
        <div className="absolute z-9 w-75 h-90 top-full -right-7 mt-3 border p-2 bg-white overflow-y-scroll">
            ...
            <div>
                <h4 className="text-xl text-center text-black/50">Subtotal:$100.00</h4>
