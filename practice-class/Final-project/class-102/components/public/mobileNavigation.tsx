...
function MobileNavigation() {
    ...
    return (
        <>
            {isActive &&
                <div className="w-[250px] h-screen shadow-xl fixed top-0 left-0 bg-white z-3 lg:hidden">
                                                        ...
                                                        {category.isActive &&
                                                            <ul className="w-full border-l ml-5 pl-4">
                                                                {category.children.map(sub1 => (
                                                                    <li key={sub1.id} className=" my-1 relative before:absolute before:-left-4 before:top-3 before:w-2.5 before:border-t before:opacity-30">
                                                                        ...
                                                                        {sub1.children.length > 0 &&
                                                                            <ul className="w-full border-l pl-4">
                                                                                {sub1.children.map(sub2 => (
                                                                                    <li key={sub2.id} className=" my-1 relative before:absolute before:-left-4 before:top-3 before:w-2.5 before:border-t before:opacity-30">
