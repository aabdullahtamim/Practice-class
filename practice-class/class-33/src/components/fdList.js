function foodList(obj) {
        ...
        return `<div class="bg-white rounded-lg overflow-hidden">
            <div class="relative">
              <img data-food_id="${obj.id}" class="w-full h-[130px] cursor-pointer foodCartItem" src="public/images/foods/${obj.image_url}" alt="food">
            ...
            <div class="flex justify-between items-center px-2 pt-2">
              <div>
                <h4 class="text-body text-3">${obj.name}</h4>
                <strong class="text-xl">৳ ${obj.price}</strong>
              </div>
